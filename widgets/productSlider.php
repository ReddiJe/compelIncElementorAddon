...
class Elementor_productSlider extends \Elementor\Widget_Base
{
...
?>
        ...
        <style>
            ...
            .ourBrands .bigImg:hover{
                box-shadow: rgba(100, 100, 111, 0.4) 0px 7px 24px 0px;
            }

            .ourBrands .splide__arrow{
    background: rgba(300, 300, 300, 0.5);
    border-radius: 15px;
}

.ourBrands .splide__arrow svg{
    fill: #2c2d2c;
}
